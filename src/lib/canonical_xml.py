...
break snapshot stability across environments.
...
def canonical_bytes(element: ElementTree.Element) -> bytes:
    ...
    ElementTree.indent(copy, space='  ')
    return b'<?xml version="1.0" encoding="utf-8"?>\n' + ElementTree.tostring(copy, encoding='utf-8')
