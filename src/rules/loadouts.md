...
extras: {
    ...
    classifications: [...]
    loadout_id:      "..."               # loadout sub-source
    rule_signature:  (("attr", "val"),...) # rule sub-source (add/remove)
    multiset:        True                # rule sub-source only if bag-diff path
    refs:            {"ship_macro": "..."}     # loadout sub-source
                   | {"applicability": {...}}  # rule sub-source
