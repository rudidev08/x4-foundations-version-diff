...
Classifications come from the ware's `<group>` and `@tags`, sorted
alphabetically (deduped via `set`).

```
tag:   "wares"
text:  "[wares] Silicon (container, economy, minable, mineral, minerals, solid) [core]: price_max 150→160"
extras: {
    entity_key:        "silicon"
    kind:              "added" | "removed" | "modified"
    classifications:   ["container", "economy", "minable", "mineral", "minerals", "solid"]
    source:            "core"               # added/removed (single string)
