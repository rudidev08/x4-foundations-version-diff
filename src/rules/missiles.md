...
extras: {
    # Standard schema (always present)
    subsource:        "missiles"
    entity_key:       ("missile_torpedo_heavy_mk1",)
    classifications:  ["torpedo", "modified"]   # [missile_class or 'missile', kind]
    ...
    # Added/removed only:
    class:            "torpedo"
    stats_new:        {"HP": "20", "damage": "1100", ...}        # added only
    # Modified only:
    class_old:        "torpedo"
    class_new:        "torpedo"
    stat_diff:        {"shielddisruption": (None, "10"), ...}
